...
const LoginPage = () => {
  ...
  // 2. Google OAuth Custom Trigger (Always clean, no email shown)
  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-[#0A0A0A] overflow-hidden px-6 pt-16">
      {/* Background Image */}
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[480px] max-h-[85vh] mt-10 flex flex-col bg-[#0F0F0F]/95 backdrop-blur-3xl border border-white/10 rounded-[40px] shadow-2xl overflow-hidden"
      >
        {/* Header */}
